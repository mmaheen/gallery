<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="{{route('photo.create')}}" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Upload</a>
            ...
            <a href="{{route('dashboard.table')}}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Tables</a>
